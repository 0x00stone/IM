...
public class index {
    public static void saveIndex(user[] User){
        try{
        FileOutputStream fos = new FileOutputStream(new File("./index2.properties"));
    ...
    public static user[] getIndex() {
        try {
            if (new File("./index2.properties").exists()) {
                FileInputStream fis = new FileInputStream(new File("./index2.properties"));
                Properties index = new Properties();
                index.load(fis);
